let locales = {
  en: {
  		messages: {
	        cityOriginNull: "Select a city of origin",    
	        destinationCityNull: "Select the destination city",
  ...
  es: {
  		messages: {
	        cityOriginNull: "Seleccione la ciudad de origen",
	        destinationCityNull: "Seleccione la ciudad de destino",
  ...
  pt: {
  		messages: {
	        cityOriginNull: "Selecione uma cidade de origem",
	        destinationCityNull: "Selecione a cidade de destino",
